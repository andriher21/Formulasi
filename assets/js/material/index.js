...
var readCSV = 'material/readCSV';
var deleteUrl = 'material/delete';
var importURL = 'material/doImport';
...
function drawImportTable(data) {
    ...
    $.each(data, function(i, v) {
        ...
        html += '<td id="jenis">' + v.jenis + '</td>';
        html += '<td id="status">' + v.status + '</td>';
        html += '<td id="konversi">' + v.konversi + '</td>';
        html += '</tr>';
    });
    if (html !== '') {
...
function doImport() {
    ...
    var materialname =[];
    var materialjenis =[];
    var materialkonversi =[];
    var materialsttimbang =[];
    $('.check-import:checked').each(function(i, dom) {
        index = $(dom).val();
        // console.log(index);
        materialno = new_u[index]['no'];
        materialname= new_u[index]['name'];
        materialjenis= new_u[index]['jenis'];
        materialkonversi= new_u[index]['konversi'];
        materialsttimbang= new_u[index]['status'];
        ...
        data.push({
            ...
            materialjenis:materialjenis,
            materialkonversi:materialkonversi,
            materialsttimbang:materialsttimbang,
        });
    });
    // console.log(data);
