                                    ...
                                    foreach ($users as $user) : ?>
                                        <tr>
                                            ...
                                            <?php } else if ($user['role_id'] == 9) { ?>
                                                <td><span class="badge badge-pill badge-info"><?= $user['fullname'] ?></span></td>
                                            <?php } else { ?>
    ...
    <div class="modal fade" id="modalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="<?= base_url('user/insert') ?>" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label for="message-text" class="col-form-label">Name</label>
                                        <input class="form-control" type="text" name="nama" value="<?= $user['fullname'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
